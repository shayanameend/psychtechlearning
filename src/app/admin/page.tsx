            ...
            {content.map((section) => (
              ...
              >
                ...
                <div className={cn("flex flex-col gap-4")}>
                  ...
                  {section.guideLink && (
                    <div className={cn("flex flex-col gap-2")}>
                      <Label className={cn("font-bold")}>Guide</Label>
                      <p className={cn("text-sm text-gray-600")}>
                        {section.guideLink}
                      </p>
                    </div>
                          ...
                          >
                            ...
                            <div className={cn("flex gap-2")}>
                              <Button
                                variant="outline"
                                size="icon"
                                className={cn("size-8 flex items-center gap-2")}
                              >
                                <EditIcon className={cn("w-4 h-4")} />
                              </Button>
                              <Button
                  ...
                  {section.sampleTestQuestions.length > 0 && (
                    <div className={cn("flex flex-col gap-2")}>
                      <Label className={cn("font-bold")}>Sample Test</Label>
                      <ul className={cn("flex flex-col gap-2")}>
                        {section.sampleTestQuestions.map((question) => (
                          <li
                            key={question.id}
                            className={cn(
                              "flex items-center justify-between gap-2",
                  ...
                  {section.finalTestQuestions.length > 0 && (
                    <div className={cn("flex flex-col gap-2")}>
                      <Label className={cn("font-bold")}>Final Test</Label>
                      <ul className={cn("flex flex-col gap-2")}>
                        {section.finalTestQuestions.map((question) => (
                          <li
                            key={question.id}
                            className={cn(
                              "flex items-center justify-between gap-2",
